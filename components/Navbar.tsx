...
export default function Navbar() {
  ...
  return <header className="sticky top-0 z-40 border-b border-[#e6eee8]/80 bg-[#fffdf7]/95 backdrop-blur">
    <div className="container flex h-[76px] items-center justify-between">
      <Link href="/" aria-label="EverSaath home"><Image src="/eversaath-logo.png" width={132} height={58} alt="EverSaath logo" className="h-[58px] w-[132px] object-contain object-left" /></Link>
